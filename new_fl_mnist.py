        ...
        for client_idx, train_loader in enumerate(client_trainloaders):
            ...
            for batch_idx,(data, target) in enumerate(train_loader):
                ...
                if batch_idx == save_batch_idx and client_idx == 0:
                    np.save(f'./expdata/truefl_mnist_true/images_epoch_{epoch}_batch_{save_batch_idx}.npy',
                            data.cpu().numpy())
                    np.save(f'./expdata/truefl_mnist_true/gradients_fc1_relu_binary_epoch_{epoch}_batch_{batch_idx}.npy',
